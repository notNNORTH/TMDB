...
public class TransAction {
    ...
    public TransAction(Context context) throws IOException, JSQLParserException, TMDBException {
//        test21();
        this.context = context;
        this.mem = new MemManager();
        this.levelManager = mem.levelManager;
        this.memConnect=new MemConnect(mem);
//        TorchSQLiteHelper torchSQLiteHelper = new TorchSQLiteHelper(context, "/data/data/drz.tmdb/res/Torch_Porto_test/Torch/db/Torch_Porto_test.db");
...
//
    ...
    public void test(Context context) throws IOException, TMDBException, JSQLParserException {
//        TorchSQLiteHelper torchSQLiteHelper = new TorchSQLiteHelper(context, "/data/data/drz.tmdb/res/Torch_Porto_test/Torch/db/Torch_Porto_test.db");
//        torchSQLiteHelper.execSQL("select 1");
...
//        torchConnect.insert();
//        TorchConnect.getTorchConnect().initEngine();
        TorchConnect torchConnect = new TorchConnect(memConnect,"/data/data/drz.tmdb/res/Torch_Porto_test",context);
        torchConnect.mapMatching();
